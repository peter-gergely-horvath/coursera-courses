...
object TweetLength {
  ...
  def tweetRemainingCharsCount(tweetText: Signal[String]): Signal[Int] = {
    Signal {
      val theLengthOfTheTweet = tweetLength(tweetText())

      MaxTweetLength - theLengthOfTheTweet
    }
  }
  ...
  def colorForRemainingCharsCount(remainingCharsCount: Signal[Int]): Signal[String] = {
    ...
    Signal {
      val remainingCharsCountNumber : Int = remainingCharsCount()

      remainingCharsCountNumber match {
